...
public class GetConversationDataTest {
    ...
    public void testGetConversationData() throws UserNotFound, MessageNotFound, IncorrectPassword, ConversationNotFound,
        ...
        Assert.assertEquals(1, Objects.requireNonNull(actualData.userProfiles.get(0).getContent()).id);
        Assert.assertEquals(-1, Objects.requireNonNull(actualData.messageData.get(0).getContent()).id);
    }
}
