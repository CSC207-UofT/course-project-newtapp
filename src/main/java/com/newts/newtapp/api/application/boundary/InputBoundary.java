...
public interface InputBoundary<ReturnType, ExceptionType extends Exception> {
     ...
     */
    ReturnType request(RequestModel request) throws ExceptionType, IncorrectPassword, UserNotFound, ConversationNotFound, MessageNotFound, UserBlocked, BlockedByUser;
}